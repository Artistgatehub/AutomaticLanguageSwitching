...
- post-install Chrome navigation uses a bundled helper script that looks for Chrome via `where chrome`, registry App Paths, and standard install locations before giving up silently
